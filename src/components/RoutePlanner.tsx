...
import { MapPinned, Route, Loader2, X } from 'lucide-react';
...
export default function RoutePlanner({
  ...
  return (
    <div className="fixed top-28 right-4 z-40 w-[min(24rem,calc(100vw-2rem))] pointer-events-none sm:right-8">
      <div className="glass-card rounded-[28px] p-4 shadow-2xl pointer-events-auto">
